...
export const handler = async (event) => {
  ...
  try {
    const {
      name, email, phone, yearJoined, tshirtSize, photoUrl, website, optInPublic
    ...
    const body = {
      ...
      quick_pay: {
        name: "Tau Centennial Registration",
    ...
    if (!resp.ok) {
      ...
      console.error("Square error:", t);
      return { statusCode: 500, body: 'Square link error' };
    }
